...
def sync_weather(db: Session, installation_row: Installation):
    params = {"latitude": installation_row.latitude, "longitude": installation_row.longitude, "hourly": "temperature_2m, cloud_cover, precipitation, wind_speed_10m, shortwave_radiation", "past_days": 7, "forecast_days": 3, "timezone": "UTC"}
